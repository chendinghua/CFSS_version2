...
public class UpdateDeviceNameDialog extends Dialog{

    public UpdateDeviceNameDialog(@NonNull Context context) {
        super(context);
    } public UpdateDeviceNameDialog(Context context, int theme) {
        super(context, theme);
    }
    ...
    public static class Builder {
        ...
        private View layout;
        private UpdateDeviceNameDialog dialog;
        ...
        public Builder(Context context) {
            ...
            dialog = new UpdateDeviceNameDialog(context, R.style.Dialog);
            LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            layout = inflater.inflate(R.layout.dialog_printer_pick_number_layout, null);
         ...
         * @return
         */
        public UpdateDeviceNameDialog createSingleButtonDialog() {
            showSingleButton();
         ...
         * @return
         */
        public UpdateDeviceNameDialog createTwoButtonDialog() {
            showTwoButton();
        ...
        public String getDeviceName(){
            ...
            return etDeviceName.getText().toString();
        }

        public Builder setCurrentDeviceName(String deviceName){
        ...
        private void create() {
           ...
           etDeviceName =  layout.findViewById(R.id.et_dialog_device_name);
         /*   if(storageInfo!=null){
                ((TextView)layout.findViewById(R.id.tv_scrap_dialog_product_id)).setText(storageInfo.getID()+"");

                ((TextView)layout.findViewById(R.id.tv_scrap_dialog_product_code)).setText(storageInfo.getCode());

                if(storageInfo.getStockInfo()!=null)
                ((TextView)layout.findViewById(R.id.tv_scrap_dialog_product_type)).setText(storageInfo.getStockInfo().getName());

                ((TextView)layout.findViewById(R.id.tv_scrap_dialog_product_lot)).setText(storageInfo.getItemNo());

                ((TextView)layout.findViewById(R.id.tv_scrap_dialog_product_putOn_time)).setText(storageInfo.getOpTime());

                ((TextView)layout.findViewById(R.id.tv_scrap_dialog_product_status)).setText(storageInfo.getStatusName()+"");
                if(storageInfo.getStockInfo()!=null) {
                    ((TextView) layout.findViewById(R.id.tv_scrap_dialog_product_stock)).setText(storageInfo.getStockInfo().getName());
                }
                ((TextView)layout.findViewById(R.id.tv_scrap_dialog_product_num)).setText(storageInfo.getNum()+"");
            }*/
